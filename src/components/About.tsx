...
const accordionData = [
  {
    ...
    content: [
      ...
      "I negotiated high-value commercial contracts.",
  ...
  },
  {
    ...
    content: [
      "I am an empathetic and smiling person who works well in teamwork.",
      "When I work independently, I am determined to achieve my goal, every problem has a solution.",
      "I am a dreamer who likes to set the bar high, we will not reach high without sufficiently high goals.",
